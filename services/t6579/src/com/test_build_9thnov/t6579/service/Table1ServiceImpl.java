...
public class Table1ServiceImpl implements Table1Service {
    ...
    public void setWMGenericDao(WMGenericDao<Table1, Table1Id> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "t6579TransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "t6579TransactionManager")
    @Override
