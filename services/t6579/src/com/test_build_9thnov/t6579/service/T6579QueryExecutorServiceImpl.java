...
@Service
public class T6579QueryExecutorServiceImpl implements T6579QueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(T6579QueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("t6579WMQueryExecutor")
